...
sample_data(p.comb.filt.s.new)$DNAex_round <- df$DNAex_round
sample_data(p.comb.filt.s.new)$PCR_round <- df$PCR_round
# sample data updated 
sample_data(physeq.nct)$sample_side <- ifelse(sample_data(physeq.nct)$sample_side == "paraffin", "paraffin_tumor", sample_data(physeq.nct)$sample_side) #modify sample side
