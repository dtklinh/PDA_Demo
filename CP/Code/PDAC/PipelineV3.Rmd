...
```{r}
physeq1.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_05_27_patho_FFPE_tum_panc_1/physeq_original_1500.80.rds")
physeq2.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_05_27_patho_FFPE_tum_panc_2/physeq_original_1500.80.rds")
physeq3.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_05_28_patho_FFPE_tum_panc_3/physeq_original_1500.80.rds")
physeq4.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_05_28_patho_FFPE_tum_panc_4/physeq_original_1500.80.rds")
#physeq5.1500.80 <- readRDS("PDA/raw_data/PhyloSeqObj/2021_12_01_patho_FFPE_self_tumor/physeq_original_1500.80.rds")
physeq6.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_08_09_patho_FFPE_tum_panc_rep1/physeq_original_1500.80.rds") #09.08.22: rep1: 10 samples (tumor+normal panc mixed)
physeq7.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_08_09_patho_FFPE_tum_panc_rep2/physeq_original_1500.80.rds") #09.08.22: rep2: 10 samples (tumor+normal panc mixed)
#merge the different phyloseq objects into 1 phyloseq object
p.true.original <- merge_phyloseq(physeq1.1500.80,physeq2.1500.80,physeq3.1500.80,physeq4.1500.80,physeq6.1500.80,physeq7.1500.80)
#clean objects
rm(list = c("physeq1.1500.80", "physeq2.1500.80", "physeq3.1500.80", "physeq4.1500.80", "physeq6.1500.80","physeq7.1500.80"))
```
...
### Loading NCTs
```{r}
physeq.nct1.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_02_patho_FFPE_tum_panc_ntc_1/physeq_original_1500.80.rds")
physeq.nct2.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_02_patho_FFPE_tum_panc_ntc_2/physeq_original_1500.80.rds")
physeq.nct3.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_03_patho_FFPE_tum_panc_ntc_3/physeq_original_1500.80.rds")
physeq.nct4.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_03_patho_FFPE_tum_panc_ntc_4/physeq_original_1500.80.rds")
physeq.nct5.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_04_patho_FFPE_tum_panc_ntc_5/physeq_original_1500.80.rds")
physeq.nct6.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_04_patho_FFPE_tum_panc_ntc_6/physeq_original_1500.80.rds")
physeq.nct7.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_06_10_patho_FFPE_tum_panc_ntc_7/physeq_original_1500.80.rds")
physeq.nct8.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_07_13_patho_FFPE_tum_panc_ntc_8/physeq_original_1500.80.rds")
physeq.nct9.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_07_13_patho_FFPE_tum_panc_ntc_9/physeq_original_1500.80.rds")
physeq.nct10.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2021_12_02_patho_FFPE_self_ntc/physeq_original_1500.80.rds")
physeq.nct11.1500.80 <- readRDS("PDAC/raw_data/PhyloSeqObj/2022_01_24_patho_FFPE_self_ntc_2/physeq_original_1500.80.rds")
#merge the different phyloseq objects into 1 phyloseq object
...
In this step, we keep all taxas in true samples whose abundance are above our threshold (eg. \<10\^-4) in atleast 1 sample
```{r}
...
# load metadata
library("readxl")
metadata <- read_excel("PDAC/raw_data/Metadata_2.xlsx") %>% as.data.frame()
metadata <- metadata[,c("uniqueID", "sample_side", "sample_nr", "TRUE_control", "DNAex_round", "PCR_round")]
metadata <- metadata %>% mutate(PCR_round = as.character(PCR_round))
head(metadata)
...
Remove samples containing 0 bacteria after filtering campaign
```{r}
p.true.RmLowAbun.RmHLPrev <- prune_samples(x = p.true.RmLowAbun.RmHLPrev,sample_sums(p.true.RmLowAbun.RmHLPrev) > 0)
```
...
if(grepl("dna", tolower(batch_type), fixed = TRUE)){
  sub.meta.data <- metadata[metadata$uniqueID %in% sample_data(p.true.RmLowAbun.RmHLPrev)$uniqueID,]
...
p.true.RmLowAbun.RmHLPrev.batchDNA
rm(batch_type)
rm(otu)
rm(sub.meta.data)
rm(batchid)
...
Remove samples containing 0 bacteria after filtering campaign
```{r}
p.true.RmLowAbun.RmHLPrev.batchDNA <- prune_samples(x = p.true.RmLowAbun.RmHLPrev.batchDNA,sample_sums(p.true.RmLowAbun.RmHLPrev.batchDNA) > 0)
```
...
if(grepl("dna", tolower(batch_type), fixed = TRUE)){
  sub.meta.data <- metadata[metadata$uniqueID %in% sample_data(p.true.RmLowAbun.RmHLPrev.batchDNA)$uniqueID,]
  sub.meta.data <- sub.meta.data %>% mutate(sample_sidev2 = as.factor(sample_side),
                                              DNAex_roundv2 = as.factor(DNAex_round))
  batchid = sub.meta.data[,c("DNAex_roundv2")]
  covar = sub.meta.data[,c("sample_sidev2")]
...
p.true.RmLowAbun.RmHLPrev.batchPCR
rm(batch_type)
rm(otu)
rm(sub.meta.data)
rm(batchid)
...
```{r}
bray_dist <- phyloseq::distance(p.true.RmLowAbun.RmHLPrev.batch, method="bray")
bc_ordination <- ordinate(p.true.RmLowAbun.RmHLPrev.batch,method = "PCoA",distance = bray_dist)
plot_ordination(physeq = p.true.RmLowAbun.RmHLPrev.batch,ordination = bc_ordination ,color = "sample_side", label = "uniqueID") + stat_ellipse()


plot_ordination(p.true.RmLowAbun.RmHLPrev.batch,ordination = bc_ordination,type = "species",color = "phylum") + stat_ellipse()
```
