...
CAH:
  ...
  ```{r}
physeq1 <- readRDS("2022_05_27_patho_FFPE_tum_panc_1/physeq_original_50.rds")
physeq2 <- readRDS("2022_05_27_patho_FFPE_tum_panc_2/physeq_original_50.rds")
physeq3 <- readRDS("2022_05_28_patho_FFPE_tum_panc_3/physeq_original_50.rds")
physeq4 <- readRDS("2022_05_28_patho_FFPE_tum_panc_4/physeq_original_50.rds")
physeq5 <- readRDS("2021_12_01_patho_FFPE_self_tumor/physeq_original.rds")
...
```{r}
physeq6 <- readRDS("2022_08_09_patho_FFPE_tum_panc_rep1/physeq_original_50.rds")
physeq7 <- readRDS("2022_08_09_patho_FFPE_tum_panc_rep2/physeq_original_50.rds")
...
Following we will apply the filter 1. Here we do not separate the control physeq object in paraffin and the other controls. We have too less buffer/ PCR H2O controls (> 7.5% would mean a whole sample, meaning all taxa from these controls will be removed). Thus we define all species as contaminant which occur in more than 7.5% of ALL controls. That means a species have to occur in `r round(nrow(sample_data(physeq.filt.nct.s.prev.filt))*0.075, digits = 0)` controls to be defined as contaminant.  
                                                                                                                                                                       ...
                                                                                                                                                                       We only have controls for filter 2 (DNA extraction) and filter 3 (PCR). First of all we separate the phyloseq objects accordingly (samples + certain control batch (PCR or buffer).
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          rp <- subset_taxa(p.comb.paraffin, species == "Moraxella osloensis" )
                                                                                                                                                                                                                                                                                                          otu_table(rp)
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          #  testing binominal for taxa prevalent in paraffin
                                                                                                                                                                                                                                                                                                          x1 <- prevalence(rp.true, detection = 0, count = TRUE)
                                                                                                                                                                                                                                                                                                          
                                                                                                                                                                                                                                                                                                          n1 <- nrow(meta(rp.true))
                                                                                                                                                                                                                                                                                                          
                                                                                                                                                                                                                                                                                                          p1 <- prevalence(rp.ntc, detection = 0, count = FALSE)
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          rownames(pvaluedf) <- rownames(bin.data.paraffin) #give dataframe the correct rownames. these are OTUs
                                                                                                                                                                                                                                                                                                          pvaluedf <- pvaluedf %>% filter(paraffin == TRUE & buffer == TRUE & pcr == TRUE) #filter those that are TRUE for all 3 rows
                                                                                                                                                                                                                                                                                                          # we keep the remaining OTUs {rownames(pvaluedf)}
                                                                                                                                                                                                                                                                                                          ---
                                                                                                                                                                                                                                                                                                            taxa_kept2 <- data.frame(OTU = rownames(pvaluedf),
                                                                                                                                                                                                                                                                                                                                     species = p.comb.filt.s.prev@tax_table@.Data[rownames(pvaluedf),"species"])
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          p.filt2.removed <- data.frame(paraffin = bin.data.paraffin$sign.p,
                                                                                                                                                                                                                                                                                                                                        buffer = bin.data.buffer$sign.p,
                                                                                                                                                                                                                                                                                                                                        pcr = bin.data.pcr$sign.p,row.names = rownames(bin.data.paraffin)) %>%
                                                                                                                                                                                                                                                                                                            filter(!(paraffin == TRUE & buffer == TRUE & pcr == TRUE)) 
                                                                                                                                                                                                                                                                                                          p.filt2.removed %>% mutate(OTU = row.names(p.filt2.removed)) %>% mutate(species = p.comb.paraffin@tax_table@.Data[rownames(p.filt2.removed),"species"] )
                                                                                                                                                                                                                                                                                                          
                                                                                                                                                                                                                                                                                                          filtered_taxa2 <- data.frame(OTU = rownames(p.filt2.removed),
                                                                                                                                                                                                                                                                                                                                       species =  p.comb.paraffin@tax_table@.Data[rownames(p.filt2.removed),"species"])
                                                                                                                                                                                                                                                                                                          
                                                                                                                                                                                                                                                                                                          #before starting filtering 
                                                                                                                                                                                                                                                                                                          #after filtering how many taxa
                                                                                                                                                                                                                                                                                                          
                                                                                                                                                                                                                                                                                                          cont_table_filter2 <- data.frame( cont = c("TRUE","FALSE"),
                                                                                                                                                                                                                                                                                                                                            n = c(nrow(filtered_taxa2),nrow(pvaluedf)))
